...
export default function AdminSidebar() {
  ...
  const menuItems = [
    { to: '/superAdmin/stores', icon: FaBox, label: 'Stores' },
    { to: '/superAdmin/banners', icon: FaImages, label: 'Banners' },
    { to: '/superAdmin/categories', icon: FaTag, label: 'Categories' },
    { to: '/superAdmin/products', icon: FaBoxOpen, label: 'Products' },
  ]
              ...
              {!isCollapsed ? (
                <div className="flex flex-col items-center w-full space-y-3">
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-xs text-gray-500 font-medium tracking-wider">SUPER ADMIN PANEL</p>
                  </div>
                </div>
              ) : (
