...
const AddStore = ({ onBack, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await storeService.createStore(cleanData);
  ...
  const InputField = ({ label, name, type = 'text', required = false, error, placeholder, ...props }) => (
    <div className="space-y-2">
      ...
      <input
        ...
        className={`w-full px-4 py-3 rounded-xl border transition-all duration-200 ${error
  ...
  return (
    <div className="min-h-screen bg-white p-6">
      {loading && <LoaderOverlay text="Creating Store..." />}
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2 text-lg">Create a new store location</p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="Enter store name (e.g., Premium Quality Foods – Dubai Outlet)"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="Unit 5, Ground Floor, Jumeirah Beach Hotel, Jumeirah Road, Jumeirah 3"
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="Dubai Emirate (optional)"
                    className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#8e191c] focus:ring-[#8e191c]/20 focus:outline-none focus:ring-2 transition-all duration-200"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    placeholder="dubai@premiumqualityfoods.ae"
                ...
                <div className="md:col-span-2">
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      placeholder="https://www.premiumqualityfoods.ae (optional)"
                      className={`w-full px-4 py-3 rounded-xl border transition-all duration-200 ${errors.website
                          ? 'border-red-300 focus:border-red-500 focus:ring-red-500/20'
                          : 'border-gray-300 focus:border-[#8e191c] focus:ring-[#8e191c]/20'
                        } focus:outline-none focus:ring-2`}
                    />
            ...
            <>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-3xl border border-gray-200 p-8 shadow-sm">
                  <div className="flex items-center space-x-3 mb-6">
                    <div className="p-2 rounded-xl bg-[#a51d20]/10 border border-[#a51d20]/20">
                      <FiGlobe className="w-5 h-5 text-[#a51d20]" />
                    </div>
