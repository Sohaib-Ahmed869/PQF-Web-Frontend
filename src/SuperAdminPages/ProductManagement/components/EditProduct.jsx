...
import { FiArrowLeft, FiSave, FiUpload, FiX, FiImage, FiCheck } from 'react-icons/fi';
...
const EditProduct = ({ product, onBack, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await superAdminProductService.updateProductImageAndDescription(productId, selectedImage, description);
