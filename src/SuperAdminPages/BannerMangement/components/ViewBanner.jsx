        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 lg:col-span-4">
            <div className="sticky top-6 space-y-6">
              {/* Store Information - NEW SECTION */}
              {banner.store_name && (
                <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-gray-200/50 p-6 shadow-xl">
                  <h4 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                    <FiHome className="w-5 h-5 mr-2 text-red-600" />
                    Store Information
                  </h4>
                  <div className="space-y-4">
                    <div>
                      <h5 className="font-semibold text-gray-900 mb-1">{banner.store_name}</h5>
                      {banner.store_address_street && (
                      ...
                      <div className="text-sm text-gray-600">
                        ...
                        {[
                          ...
                          banner.store_address_state,
                          banner.store_address_country
                        ].filter(Boolean).join(', ')}
                        {banner.store_address_zipCode && ` - ${banner.store_address_zipCode}`}
                      </div>
                    </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl border border-gray-200/50 p-6 shadow-xl">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Banner ID</span>
