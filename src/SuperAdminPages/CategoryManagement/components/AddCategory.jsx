...
import superAdminCategoryService from '../../../services/SuperAdmin/categoryService';
...
const AddCategory = ({ onBack, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await superAdminCategoryService.createCategory({
        name: name.trim(),
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/50 p-6 shadow-xl">
              ...
              <div className="mb-6">
                ...
                <Select
                  ...
                  onChange={opt => setSelectedStoreId(opt ? opt.value : '')}
                  isClearable
                  isSearchable
        ...
        <div className="flex justify-end gap-4 pt-6">
          ...
          <button
            ...
            disabled={loading || !selectedImage || !name.trim() || !itemsGroupCode.trim() || !selectedStoreId}
